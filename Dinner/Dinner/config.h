...
#define MODIFY_AVATAR_API @"http://localhost/dinner/branches/beta/index.php?r=api/center/modifyavatar" //修改头像
...
//#define CHECK_VERSION_API @"http://localhost/dinner/index.php?r=api/index/getversion" //检查更新接口
//#define CANCEL_ORDER_API @"http://localhost/dinner/index.php?r=api/center/cancelorder" //取消订单接口
//#define MODIFY_AVATAR_API @"http://localhost/dinner/index.php?r=api/center/modifyavatar" //修改头像
