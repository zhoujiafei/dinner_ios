...
-(void)getCacheData
{
    NSArray *data = [[DataManage shareDataManage] getData:CACHE_NAME withNetworkApi:[NSString stringWithFormat:GET_TODAY_ORDER_API,_accessToken]];
    if (data)
    {
...
{
    __weak ASIHTTPRequest *request = [ASIHTTPRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:GET_TODAY_ORDER_API,_accessToken]]];
    [request setCompletionBlock:^{
        ...
        //保存数据
        [[DataManage shareDataManage] insertData:CACHE_NAME withNetworkApi:[NSString stringWithFormat:GET_TODAY_ORDER_API,_accessToken] withObject:returnData];
